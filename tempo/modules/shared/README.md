...
| <a name="input_tempo_helm_version"></a> [tempo\_helm\_version](#input\_tempo\_helm\_version) | The version of the tempo helm chart to use | `string` | `"2.25.2"` | no |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_tempo_gateway_url"></a> [tempo\_gateway\_url](#output\_tempo\_gateway\_url) | n/a |
| <a name="output_tempo_otlp_grpc_url"></a> [tempo\_otlp\_grpc\_url](#output\_tempo\_otlp\_grpc\_url) | n/a |
| <a name="output_tempo_otlp_http_url"></a> [tempo\_otlp\_http\_url](#output\_tempo\_otlp\_http\_url) | n/a |
<!-- END_TF_DOCS -->
